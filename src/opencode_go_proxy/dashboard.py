...
<body>
  <main>
    ...
    <section aria-labelledby="routing-title">
      ...
      <p class="fallback-config"><span>Fallback targets</span><code id="fallback-setting">Go: go/gpt-5.6-luna · Zen: zen/gpt-5.6-luna</code></p>
    </section>
